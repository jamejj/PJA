        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackRaceRaceId = table.Column<int>(type: "int", nullable: true),
                    TrackRaceTrackId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Race_Participation", x => new { x.RaceId, x.TrackId, x.RacerId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Race_Participation_Races_RaceId",
                        column: x => x.RaceId,
                        principalTable: "Races",
                        principalColumn: "RaceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Race_Participation_Track_Race_TrackRaceRaceId_TrackRaceTrackId",
                        columns: x => new { x.TrackRaceRaceId, x.TrackRaceTrackId },
                        principalTable: "Track_Race",
                        principalColumns: new[] { "RaceId", "TrackId" });
                    table.ForeignKey(
                        name: "FK_Race_Participation_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "TrackId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "RaceId", "RacerId", "TrackId", "FinishTimeInSeconds", "Position", "TrackRaceRaceId", "TrackRaceTrackId" },
                values: new object[,]
                {
                    { 1, 1, 1, 5460, 1, null, null },
                    { 2, 2, 2, 6300, 2, null, null }
                });

            migrationBuilder.InsertData(
                table: "Track_Race",
                columns: new[] { "RaceId", "TrackId", "BestTimeInSeconds", "Laps" },
                values: new object[,]
                {
                    { 1, 1, 5460, 52 },
                    { 2, 2, 6300, 78 }
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Race_Participation_TrackId",
                table: "Race_Participation",
                column: "TrackId");

            migrationBuilder.CreateIndex(
                name: "IX_Race_Participation_TrackRaceRaceId_TrackRaceTrackId",
                table: "Race_Participation",
                columns: new[] { "TrackRaceRaceId", "TrackRaceTrackId" });
