...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMaxSalary()
    {
        ...
        decimal? maxSalary = emps.Where(e => e.DeptNo == e.DeptNo).Max(e => e.Sal); 
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(e => e.DeptNo == 30).Average(e => e.Sal);
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        var emps = Database.GetEmps();
         ...
         var firstTwo = emps.OrderBy(e => e.HireDate).Where(e => e.HireDate == e.HireDate).Take(2).ToList(); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        var emps = Database.GetEmps();
         ...
         var result = emps.Join(emps, e => e.Mgr, m => m.EmpNo, (emp, mgr) => new 
             {Employee = emp.EName, Manager = mgr.EName}).ToList();
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        var emps = Database.GetEmps();
         ...
         //var result = emps.Select(e => new {e.EName, TotalIncome = e.Sal + (e.Comm ??)}); 
